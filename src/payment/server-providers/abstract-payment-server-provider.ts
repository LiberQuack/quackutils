...
export abstract class AbstractPaymentServerProvider<PD> implements PaymentProviderBaseProperties {
     ...
     */
    abstract checkout(user: PaymentUser, checkoutObj: PaymentCalculatedCheckout<PD>): Promise<PaymentProviderCheckoutResult>;

    /**
     * Implement checkout cancel
     */
    abstract cancelCheckout(user: PaymentUser, checkoutObj: PaymentCompletedCheckout<PD>): Promise<PaymentProviderCheckoutResult>;
     ...
     * @param data
     */
    abstract handleWebhook(user: PaymentUser, checkout: PaymentCalculatedCheckout<PD> | PaymentCompletedCheckout<PD>, webhookData: any): Promise<PaymentProviderCheckoutResult | void>

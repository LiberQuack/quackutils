...
// import {PaymentCheckout, PaymentProduct, PaymentUser, PaymentUserAccountsProperties} from "../types";
//
...
//     }
//
//     checkout(user: PaymentUser, checkoutObj: PaymentCheckout): Promise<PaymentCheckout> {
//         return Promise.resolve(checkoutObj);
//     }
//
// }
var $1SSP2$haunted = require("haunted");
var $1SSP2$hauntedlibcore = require("haunted/lib/core");
var $1SSP2$lit = require("lit");
var $1SSP2$litdirectivesunsafehtml = require("lit/directives/unsafe-html");
var $1SSP2$sharebuttons = require("share-buttons");
...
parcelRequire.register("l9sLc", function(module, exports) {

$parcel$export(module.exports, "ShareElement", () => $fd323a445000626d$export$daefdd33db3ae1c7);
...
var $bnYEd = parcelRequire("bnYEd");

var $iF9hY = parcelRequire("iF9hY");

var $j6g34 = parcelRequire("j6g34");

var $68biC = parcelRequire("68biC");
const $fd323a445000626d$export$daefdd33db3ae1c7 = function() {
    (0, $68biC.css)`
        share-element a {
    ...
    `;
    (0, $1SSP2$hauntedlibcore.useEffect)(()=>{
        this.classList.add("share-btn");
        (0, ($parcel$interopDefault($1SSP2$sharebuttons))).update();
    ...
    return (0, $1SSP2$lit.html)`
        <a data-url="${document.location.href}" data-id="tw">${(0, $1SSP2$litdirectivesunsafehtml.unsafeHTML)((0, (/*@__PURE__*/$parcel$interopDefault($iF9hY))))}</a>
        <a data-url="${document.location.href}" data-id="fb">${(0, $1SSP2$litdirectivesunsafehtml.unsafeHTML)((0, (/*@__PURE__*/$parcel$interopDefault($bnYEd))))}</a>
        <a data-url="${document.location.href}" data-id="wa">${(0, $1SSP2$litdirectivesunsafehtml.unsafeHTML)((0, (/*@__PURE__*/$parcel$interopDefault($j6g34))))}</a>
    `;
};
/**
 * Add in the future
 ...
 */ customElements.define("share-element", (0, $1SSP2$haunted.component)($fd323a445000626d$export$daefdd33db3ae1c7, {
    useShadowDOM: false
}));

});
parcelRequire.register("bnYEd", function(module, exports) {
...
parcelRequire.register("iF9hY", function(module, exports) {
...
parcelRequire.register("j6g34", function(module, exports) {
...
parcelRequire.register("68biC", function(module, exports) {

$parcel$export(module.exports, "css", () => $709adf60fc2d1665$export$dbf350e5966cf602);
let $709adf60fc2d1665$var$memory = [];
const $709adf60fc2d1665$export$dbf350e5966cf602 = (template, ...values)=>{
    let text = "";
    ...
    if ($709adf60fc2d1665$var$memory.indexOf(text) > -1) return;
    let styleElement = document.createElement("style");
    styleElement.innerHTML = text;
    document.head.appendChild(styleElement);
    $709adf60fc2d1665$var$memory.push(text);
};
...
//# sourceMappingURL=share-element.e4a0893a.js.map

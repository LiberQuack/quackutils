...
parcelRequire.register("HWFlE", function(module, exports) {

$parcel$export(module.exports, "ShareElement", () => $021682b358b65c6b$export$daefdd33db3ae1c7);
...
var $8gTmT = parcelRequire("8gTmT");

var $9grHP = parcelRequire("9grHP");

var $7MeHt = parcelRequire("7MeHt");

var $jJAoy = parcelRequire("jJAoy");
const $021682b358b65c6b$export$daefdd33db3ae1c7 = function() {
    (0, $jJAoy.css)`
        share-element a {
    ...
    return (0, $k6j4s.html)`
        <a data-url="${document.location.href}" data-id="tw">${(0, $51bNG.unsafeHTML)((0, (/*@__PURE__*/$parcel$interopDefault($9grHP))))}</a>
        <a data-url="${document.location.href}" data-id="fb">${(0, $51bNG.unsafeHTML)((0, (/*@__PURE__*/$parcel$interopDefault($8gTmT))))}</a>
        <a data-url="${document.location.href}" data-id="wa">${(0, $51bNG.unsafeHTML)((0, (/*@__PURE__*/$parcel$interopDefault($7MeHt))))}</a>
    `;
};
/**
 * Add in the future
 ...
 */ customElements.define("share-element", (0, $7WcZB.component)($021682b358b65c6b$export$daefdd33db3ae1c7, {
    useShadowDOM: false
}));
...
parcelRequire.register("8gTmT", function(module, exports) {
...
parcelRequire.register("9grHP", function(module, exports) {
...
parcelRequire.register("7MeHt", function(module, exports) {
...
parcelRequire.register("jJAoy", function(module, exports) {

$parcel$export(module.exports, "css", () => $0e1c09788346ac87$export$dbf350e5966cf602);
let $0e1c09788346ac87$var$memory = [];
const $0e1c09788346ac87$export$dbf350e5966cf602 = (template, ...values)=>{
    let text = "";
    ...
    if ($0e1c09788346ac87$var$memory.indexOf(text) > -1) return;
    let styleElement = document.createElement("style");
    styleElement.innerHTML = text;
    document.head.appendChild(styleElement);
    $0e1c09788346ac87$var$memory.push(text);
};

...
export declare type PaymentProviderMinimalProperties = {
    provider: string;
};
export declare type PaymentEnforceProviderBase<T extends PaymentProviderMinimalProperties> = T;
export declare type PaymentUserAccount = PaymentProviderMinimalProperties;
export declare type PaymentUserData = {
    lastCheckout?: PaymentProviderCheckout;
    accounts?: PaymentUserAccount[];
    subscription?: PaymentUserSubscriptionProperties;
};
export declare type PaymentUser = {
    _id: string;
    email: string;
    payment?: PaymentUserData;
};
export declare type PaymentUserSubscriptionProperties = {
    provider: string;
    providerId: string;
 ...
 */
export declare type PaymentProduct = {
    _id: string;
    title: string;
    price: number;
    code: string;
...
export declare type PaymentProductProviderData = {
    provider: string;
    data: any;
};
/**
 ...
 */
export declare type PaymentCoupon = {
    _id: string;
    code: string;
    expiresAt?: Date;
...
export declare type PaymentPartialCheckout = PaymentProviderMinimalProperties & {
    err?: any;
...
export declare type PaymentCheckout = PaymentProviderMinimalProperties & {
    _id?: ObjectID;
    coupon_code?: PaymentCoupon["code"];
    userId: PaymentUser["_id"];
    subtotal: number;
...
export declare type ProviderName<PM extends AbstractPaymentServer<any, any, any>> = ValuesType<PM["providers"]>["provider"];
export declare type CreateCardData<PM extends AbstractPaymentServer<any, any, any>> = Parameters<Extract<ValuesType<PM["providers"]>, PaymentAccountProvider>["createCard"]>[1];

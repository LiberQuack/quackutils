...
export declare type PaymentProviderCheckoutProductsResult = {
    productObj: PaymentProduct;
    providerData: PaymentProductProviderData;
};
export declare type PaymentProviderCheckout = PaymentCheckout & {
    success: boolean;
    providerData: any;
    externalId: string;
    period?: Date;
...
export declare type PaymentProviderCheckoutResult = {
...
export interface PaymentProvider extends PaymentProviderBaseProperties {
     ...
     * @param data
     */
    readWebhookCustomer(data: any): Promise<{
        id: string;
    } | {
        email: string;
    } | void>;
     ...
     * @param data
     */
    readWebhookCheckout(user: PaymentUser, data: any): Promise<{
...
export declare type PaymentAccountProviderType<T> = T extends PaymentAccountProvider<infer U, any> ? U | PaymentUserAccount : unknown;
export declare type PaymentAccountProviderData<T> = T extends PaymentAccountProvider<any, infer U> ? U : unknown;
